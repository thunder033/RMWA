 ...
 */
"use strict";
angular.module('pulsar.flare').service('Flare', function (MScheduler, MEasel, SampleCount, Effects, FrequencyRanges, MColor, WaveformAnalyzer, FrequencyAnalyzer, FrequencyPinwheel, MParticleEmitter2D) {
